...
const ABI = require("../artifacts/contracts/car.sol/car.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("car");
  const nft = await NFT.attach("0xC55d9451d6256D93a6BB2430b5025e7AC3B3C82C");
